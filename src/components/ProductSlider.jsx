      ...
      {pages.map((page, index) => {
        return (
          <SwiperSlide key={index}>
            <div
              className="grid grid-cols-2 gap-x-5 md:grid-cols-3 
            ...
            >
              {page.productList.map((product, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="hover:shadow-1
                                    rounded-[18px] w-full max-w-[285px] h-full max-h-[292px] flex 
                                    items-center justify-center mb-[15px] relative transition "
                    >
